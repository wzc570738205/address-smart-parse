...
let code = "[`~!@#$^&*()=|{}':;',\\[\\].<>/?~！@#￥……&*（）——|{}【】‘；：”“’。，、？-] "
let keyM = ['联系电话', '电话', '联系人手机号码', '联系人', '手机号码', '手机号', '手机', '邮编', '姓名', '收货人', '收件人']
//地址特殊处理
let keyA = ['收货地址', '收件地址', '退货地址', '所在地区', '所在地', '联系地址', '送货地址', '详细地址', '地区', '地址']

let keyC = ['省 ', '市 ', '区 ', '道 ', '县 ', '镇 ', '处 ', '栋 ']
let keyD = ['重庆 ', '上海 ', '北京 ', '天津 ', '市辖区', '86-', '(86)', '（', '）', '&middot;']
let keyMs = []
let keyAs = []
